        ...
        <table class="inventory_table">
            ...
            <?php foreach ($items as $item) : { ?>
                    <tr id='<?php echo htmlspecialchars($item["inventory_id"]) ?>'>
                        ...
                        <td>
                            <input type="submit" value="Use" onclick="useItem(<?php echo htmlspecialchars($item['inventory_id']) ?>)" id="btnUseInventory" />
                            <input type="submit" value="Discard" onclick="dropItem()" id="btnDropInventory" />
                        </td>
                    </tr>
            <?php }
                endforeach; ?>
