            ...
            <table class="inventory_table">
                ...
                <?php foreach ($items as $item) : { ?>
                        <tr id='<?php echo htmlspecialchars($item["inventory_id"]) ?>'>
                            ...
                            <td>
                                <input type="submit" value="Use" onclick="useItem(<?php echo htmlspecialchars($item['inventory_id']) . ',' ?><?php echo htmlspecialchars($item['item_category']) . ',' ?><?php echo htmlspecialchars($item['item_description']) ?>)" id="btnUseInventory" />
